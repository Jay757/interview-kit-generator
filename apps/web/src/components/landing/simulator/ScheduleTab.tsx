...
export function ScheduleTab({ schedule, theme }: ScheduleTabProps) {
  ...
  return (
    <div className="space-y-4 animate-fadeIn font-mono">
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-1 pb-3 border-b border-white/[0.06]">
        <div>
        ...
        <span className="text-xs text-zinc-400">Total: {totalMins} mins allocated</span>
      </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[11px] text-zinc-500">{item.focus}</div>
              </div>
            </div>
            <div className="flex items-center gap-1 text-zinc-400 shrink-0 text-[11px] self-end sm:self-auto">
