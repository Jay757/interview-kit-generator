/**
 * Shared Kit types — mirrored from apps/api/src/types/kit.ts
 * These are pure TypeScript type definitions with NO runtime side effects.
 * Using a local copy prevents cross-workspace imports that break Next.js HMR.
 */
